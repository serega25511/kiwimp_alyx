...
const precfgloc = "./config.json"
const precfg = fs.existsSync(precfgloc) ? JSON.parse(fs.readFileSync(precfgloc)) : {};

const cfg = {
	port: precfg.port || 1337,
	//wsPort: precfg.port+1000 || 2337, // comment out if you don't need websocket bridge
